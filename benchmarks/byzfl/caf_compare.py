#!/usr/bin/env python
"""Benchmark the ByzFL implementation of CAF."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark ByzFL's CAF aggregator.")
    parser.add_argument(
    ...
    parser.add_argument("--f", type=int, default=8, help="Fault tolerance parameter.")
...
def _require_byzfl() -> "type[object]":
    try:
        from byzfl.aggregators.aggregators import CAF as ByzflCAF
...
def main() -> None:
    ...
    try:
        ...
        runs = [BenchmarkRun("ByzFL CAF", avg_seconds)]
    except TimeoutError:
        label = "ByzFL CAF (timeout)"
