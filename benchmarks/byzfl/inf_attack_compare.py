#!/usr/bin/env python
"""
Benchmark the ByzFL implementation of the Inf attack.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark ByzFL's Inf attack.")
...
def _require_byzfl() -> "type[object]":
    try:
        from byzfl.attacks.attacks import Inf as ByzflInf
