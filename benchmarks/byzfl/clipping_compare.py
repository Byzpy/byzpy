#!/usr/bin/env python
"""Benchmark the ByzFL static clipping pre-aggregator."""
...
def main() -> None:
    ...
    preagg = byzfl_cls(c=args.threshold)
    ...
    try:
        ...
        runs = [BenchmarkRun("ByzFL Clipping", avg_seconds)]
    except TimeoutError:
        label = "ByzFL Clipping (timeout)"
