#!/usr/bin/env python
"""
Benchmark the Little attack using the simplified API.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark Little attack using simplified API."
    )
...
def _print(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nLittle Attack Benchmark (Simplified API)")
    print("----------------------------------------")
