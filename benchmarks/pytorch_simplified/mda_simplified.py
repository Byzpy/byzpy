#!/usr/bin/env python
"""
Benchmark the Minimum Diameter Averaging (MDA) aggregator using the simplified API.
"""
...
async def _time_run_operator(
    operator: MinimumDiameterAveraging,
    grads: Sequence[torch.Tensor],
    *,
...
def _print_results(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nMinimum Diameter Averaging Benchmark (Simplified API)")
    print("----------------------------------------------------")
