#!/usr/bin/env python
"""
Benchmark the Centered Clipping aggregator using the simplified API.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark Centered Clipping using simplified API."
    )
    parser.add_argument(
...
def _print_results(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nCentered Clipping Benchmark (Simplified API)")
    print("--------------------------------------------")
