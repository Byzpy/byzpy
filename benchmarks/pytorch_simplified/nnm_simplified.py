#!/usr/bin/env python
"""
Benchmark the Nearest Neighbor Mixing pre-aggregator using the simplified API.
"""
...
async def _time_run_operator(
    operator: NearestNeighborMixing,
    vecs: Sequence[torch.Tensor],
    *,
...
def _print(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nNearest Neighbor Mixing Benchmark (Simplified API)")
    print("--------------------------------------------------")
