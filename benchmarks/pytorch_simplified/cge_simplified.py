#!/usr/bin/env python
"""
Benchmark Comparative Gradient Elimination using the simplified API.
"""
...
async def _time_run_operator(
    operator: ComparativeGradientElimination,
    grads: Sequence[torch.Tensor],
    *,
...
def _print(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nComparative Gradient Elimination Benchmark (Simplified API)")
    print("---------------------------------------------------------")
