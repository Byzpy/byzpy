#!/usr/bin/env python
"""
Benchmark the Gaussian attack using the simplified API.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark Gaussian attack using simplified API."
    )
...
def _print(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nGaussian Attack Benchmark (Simplified API)")
    print("------------------------------------------")
