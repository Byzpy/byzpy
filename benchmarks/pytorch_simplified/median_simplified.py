#!/usr/bin/env python
"""
Benchmark the Coordinate-wise Median aggregator using the simplified API.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark Coordinate-wise Median using simplified API."
    )
    parser.add_argument(
...
def _print_results(runs: Sequence[BenchmarkRun]) -> None:
    ...
    print("\nCoordinate-wise Median Benchmark (Simplified API)")
    print("-------------------------------------------------")
