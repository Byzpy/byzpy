#!/usr/bin/env python
"""
Benchmark the Mimic attack with and without ActorPool chunking.
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark Mimic attack chunking.")
...
async def _benchmark(args: argparse.Namespace) -> list[BenchmarkRun]:
    ...
    graph = make_single_operator_graph(
        node_name="mimic",
        operator=MimicAttack(epsilon=args.epsilon, chunk_size=args.chunk_size),
